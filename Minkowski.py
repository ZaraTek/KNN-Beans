...
plt.savefig(fname = "M_Testing_Accuracy.png", transparent = True)
plt.show()
...
plt.savefig(fname = "M_Forest_Feauture_Importance.png", transparent = True)
plt.show()
...
plt.savefig(fname = "M_Train_Test_LinePlot.png", transparent = True)
plt.show()
...
plt.savefig(fname = "M_Error_Rate.png", transparent = True)
plt.show()